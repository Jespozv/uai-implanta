...
<head>
  ...
  <title> ImPlanta el cambio! </title>
...
<body>
              ...
              <div class="row">
                <div class="col-md-12">
                  <div class="detail-box">
				   <h1>
                      ¿Te gustaría impactar positivamente?
                    </h1>
					<!--
					<div class="btn-box">
                      <a href="#" class="btn1">
          ...
          <div class="col-md-4">
            <div class="box ">
              ...
              <div class="detail-box">
                ...
                <p>
                  Encuéntranos en el mapa, estamos cerca... observa y descúbrenos...
                </p>
              </div>
            </div>
          </div>
    ...
    <div class="container">
      <div class="heading_container heading_center">
        ...
        <p class="col-md-10 mx-auto px-0">
          Somos estudiantes del magister de innovación de la Universidad Adolfo Ibañez generación 2022, hoy nos encontramos desarrollando una idea creativa para impactar de forma positiva en 1000 personas...
        </p>
      </div>
      <div class="row">
          ...
          <div class="box">
            ...
            <div class="detail-box">
              <div class="social_box">
                ...
                <a href="https://www.linkedin.com/in/pablocovacevich/" target="_blank">
          ...
          <div class="box">
            ...
            <div class="detail-box">
              <div class="social_box">
                ...
                <a href="https://www.linkedin.com/in/nicolaslillo/" target="_blank">
                  <i class="fa fa-linkedin" aria-hidden="true"></i>
                </a>
              </div>
              <h5>
          ...
          <div class="box">
            ...
            <div class="detail-box">
              <div class="social_box">
                ...
                <a href="https://www.linkedin.com/in/sebasti%C3%A1n-hern%C3%A1ndez-rom%C3%A1n-348ab73a/" target="_blank">
                  <i class="fa fa-linkedin" aria-hidden="true"></i>
                </a>
              </div>
              <h5>
		...
		<div class="col-sm-6 col-lg-3 mx-auto">
          <div class="box">
            <div class="img-box">
              <img src="images/jorge.jpg" alt="">
            </div>
            <div class="detail-box">
              <div class="social_box">
				<a href="https://www.instagram.com/jorgeespozv/" target="_blank">
                  <i class="fa fa-instagram" aria-hidden="true"></i>
                </a>
                <a href="https://www.linkedin.com/in/jorge-espoz-vidal/" target="_blank">
                  <i class="fa fa-linkedin" aria-hidden="true"></i>
                </a>
              </div>
              <h5>
  ...
  <!-- font-awesome-->
  <script src="https://kit.fontawesome.com/30c46ab053.js" crossorigin="anonymous"></script>
  <!-- popper js -->
